...
public class MediaVideoEncoder extends MediaEncoder {
    ...
    protected void prepare() throws IOException {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && isHuaWeiDevice()) {
            if (newHeight > 1920 || newWidth > 1080) {
                newHeight = 1920;
                newWidth = 1080;
            }
        }

        final MediaFormat format = MediaFormat.createVideoFormat(MIME_TYPE, newWidth, newHeight);
...
//            MediaCodecInfo.CodecCapabilities.COLOR_QCOM_FormatYUV420SemiPlanar,
    ...
    protected void signalEndOfInputStream() {
        ...
        if (mMediaCodec != null) {
            //todo 修正 IllegalStateException if not in the Executing or Configured state.
            try {
    ...
    private boolean isHuaWeiDevice() {
        ...
        return (!TextUtils.isEmpty(manufacturer) && HUA_WEI_LOWER_CASE.equals(manufacturer.toLowerCase()));
    }
